  ...
  return (
    <>{show && <>
      <div className="Theme3">
        <img className="back" onClick={(e) => { handleClick(0, e) }} src="https://i.pinimg.com/originals/ab/20/47/ab20472dd2864bcf048200c098e739c9.jpg" alt="." />
